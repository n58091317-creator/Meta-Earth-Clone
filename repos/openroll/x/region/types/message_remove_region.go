...
func NewMsgRemoveRegion(creator string, proofHeight uint64, storeHash []byte, storeProof []byte, proofs []byte, regions []*Item) *MsgRemoveRegion {
...
func (msg *MsgRemoveRegion) Route() string { return RouterKey }

func (msg *MsgRemoveRegion) Type() string { return TypeMsgRemoveRegion }
