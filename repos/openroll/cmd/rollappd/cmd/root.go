...
import (
	...
	"github.com/st-chain/dymint/cmd/dymint/commands"
	dymintconf "github.com/st-chain/dymint/config"
	rdkserver "github.com/st-chain/me-rdk/server"
	"github.com/st-chain/me-rdk/utils"
	"github.com/st-chain/rollapp/app"
	"github.com/st-chain/rollapp/app/params"
	rollutils "github.com/st-chain/rollapp/utils"
)
...
func initRootCmd(
	...
	rootCmd.AddCommand(commands.NewFixedTxIndexCmd())
	...
	rootCmd.AddCommand(layer1.CmdSyncIndepently())
}
