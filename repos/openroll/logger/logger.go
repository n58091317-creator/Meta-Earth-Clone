...
type WrapCmLogger struct {
	MeLogger
}

func (wl *WrapCmLogger) With(keyvals ...interface{}) cmlog.Logger {
	if len(keyvals)%2 != 0 {
	...
	return &WrapCmLogger{
		MeLogger{
			Logger:  wl.Logger,
			context: append(wl.context, keyvals...),
		},
	}
}
...
func (l MeLogger) With(keyvals ...interface{}) tmlog.Logger {
