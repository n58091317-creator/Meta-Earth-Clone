...
SETTLEMENT_CHAIN_ID="mechain_100-1"
...
ROLLAPP_RPC_FOR_RELAYER="http://192.168.0.198:26657"
SETTLEMENT_RPC_FOR_RELAYER="http://192.168.0.197:26657"
...
echo $ROLLAPP_CHAIN_ID
echo $SETTLEMENT_CHAIN_ID
