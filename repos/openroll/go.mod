module github.com/st-chain/rollapp
...
require (
	...
	github.com/st-chain/dymint v0.0.0-20251203061649-bb9d042507cb
	github.com/st-chain/me-rdk v1.6.2-rc04
...
require (
	...
	github.com/dymensionxyz/dymint v1.5.2 // indirect
...
replace (
	...
	// Fix badger v3 + ristretto compatibility
...
replace (
	...
	github.com/dymensionxyz/dymension => github.com/st-chain/me-hub/v3 v3.1.1-rollapp-sdk-0.46
...
replace github.com/CosmWasm/wasmd => github.com/decentrio/wasmd v0.33.0-sdk46.2

replace github.com/ipfs/go-log/v2 => github.com/zenzenless/go-log/v2 v2.66.6
