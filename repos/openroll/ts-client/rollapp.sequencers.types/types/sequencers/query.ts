...
export const QuerySequencersResponse = {
  ...
  fromJSON(object: any): QuerySequencersResponse {
    return {
      sequencers: Array.isArray(object?.sequencers) ? object.sequencers.map((e: any) => Validator.fromJSON(e)) : [],
  ...
  toJSON(message: QuerySequencersResponse): unknown {
    ...
    if (message.sequencers) {
      obj.sequencers = message.sequencers.map((e) => e ? Validator.toJSON(e) : undefined);
    } else {
      obj.sequencers = [];
    }
    message.pagination !== undefined
...
export const QuerySequencerRequest = {
  ...
  fromJSON(object: any): QuerySequencerRequest {
    return { sequencerAddr: isSet(object.sequencerAddr) ? String(object.sequencerAddr) : "" };
  },

  toJSON(message: QuerySequencerRequest): unknown {
    const obj: any = {};
    message.sequencerAddr !== undefined && (obj.sequencerAddr = message.sequencerAddr);
    return obj;
  },
...
export const QuerySequencerResponse = {
  ...
  toJSON(message: QuerySequencerResponse): unknown {
    ...
    message.sequencer !== undefined
      && (obj.sequencer = message.sequencer ? Validator.toJSON(message.sequencer) : undefined);
    return obj;
  },
...
export class QueryClientImpl implements Query {
  ...
  Sequencers(request: QuerySequencersRequest): Promise<QuerySequencersResponse> {
    ...
    const promise = this.rpc.request("rollapp.sequencers.types.Query", "Sequencers", data);
  ...
  Sequencer(request: QuerySequencerRequest): Promise<QuerySequencerResponse> {
    ...
    const promise = this.rpc.request("rollapp.sequencers.types.Query", "Sequencer", data);
    return promise.then((data) => QuerySequencerResponse.decode(new _m0.Reader(data)));
  }

  HistoricalInfo(request: QueryHistoricalInfoRequest): Promise<QueryHistoricalInfoResponse> {
    const data = QueryHistoricalInfoRequest.encode(request).finish();
    const promise = this.rpc.request("rollapp.sequencers.types.Query", "HistoricalInfo", data);
    return promise.then((data) => QueryHistoricalInfoResponse.decode(new _m0.Reader(data)));
  }

  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    const data = QueryParamsRequest.encode(request).finish();
    const promise = this.rpc.request("rollapp.sequencers.types.Query", "Params", data);
