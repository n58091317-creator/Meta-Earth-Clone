...
// In production/deployment mode the dashboard is NOT started by its own workflow,
// so the api-server spawns it. In development both run as separate Replit workflows,
// so we skip the spawn to avoid a port-5000 race condition.
